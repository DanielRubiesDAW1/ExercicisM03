...
/**
 * Renombra la variable  a resultat
...
public class ConversioDecimalSenseRefraccionar
{
    ...
    private void dec_bin(String resultat) throws NumberFormatException {
        int dec=Integer.parseInt(resultat);
        resultat=Integer.toBinaryString(dec);
        System.out.print("BINARIO: "+resultat);
    }

    private void dec_hex(String resultat) throws NumberFormatException {
